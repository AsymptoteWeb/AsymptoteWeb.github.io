...
class HomeScreen_v4 extends StatefulWidget {
  const HomeScreen_v4({Key? key}) : super(key: key);

  @override
  _HomeScreen_v4State createState() => _HomeScreen_v4State();
}

class _HomeScreen_v4State extends State<HomeScreen_v4> {
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Expanded(
                          flex: 1,
                          child: Image.asset('images/logo empty.png', height: 55, width: 55, color: Colors.white,)),
                      Expanded(
                        flex: 2,
                        child: Padding(
